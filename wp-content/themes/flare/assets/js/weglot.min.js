var Weglot = function() {
    ...
    function l(e) {
        ...
        function n(e, n, r) {
            var o = r.sendToConsole;
            void 0 === o && (o = !0);
            var a = r.consoleOverride,
                l = r.sendToDatadog;
            if (void 0 === l && (l = !0), l && "dev" !== c && function(e, t, n) {
                    "string" == typeof t && (t = {
                        message: t
                    });
                    ...
                    var o = Object.keys(s).map((function(e) {
                        return e + "=" + s[e]
                    })).join("&");
                    fetch("https://http-intake.logs.datadoghq.com/api/v2/logs?" + o, {
                        method: "POST",
    ...
    function g(e, t) {
        return void 0 === t && (t = !0), f("__validTextNodes", e, (function(e) {
    ...
    function p(e) {
        try {
            if (n.mergedSelectorRemove && k(e, n.mergedSelectorRemove)) return !1
        } catch (e) {}
    ...
    function h(e) {
        ...
        for (var t = 0, n = e.children; t < n.length; t += 1) {
            var r = n[t];
            if (r.wgNoTranslate || h(r)) return !0
        }
        return !1
    }
    ...
    var y = function(e, t) {
            return function(n, r) {
                try {
                    var o = r;
                    return -1 !== o.indexOf(":") && (o = o.replace(/([^\\]):/g, "$1\\:")), n[e] ? n[e](o) : t
                } catch (o) {
                    try {
                        return n[e] ? n[e](r) : t
                    } catch (e) {
                ...
                if (t && t.length) {
                    ...
                    if (i)
                        for (var s = function() {
                            ...
                            }, c = 0, l = i; c < l.length; c += 1) s()
                }
            }(t), !n.whitelist || !n.whitelist.length) return [].concat(function(e) {
            var t = document.getElementsByTagName("title")[0];
            if (e !== document.documentElement || !document.title || !t || v(t)) return [];
            return [{
    ...
    function O(e) {
        return [].concat(function(e) {
            ...
            return H.forEach((function(n) {
                for (var r, o, a, i = n.attribute, s = n.type, c = n.selectors, l = 0, u = (r = e, o = [], a = c.join(","), r.matches && r.matches(a) && o.push(r), r.childElementCount > 0 && o.push.apply(o, r.querySelectorAll(a)), o); l < u.length; l += 1) {
                    var f = u[l];
                    if (!v(f)) {
                        var d = i.get(f);
                        j(d) || t.push({
            ...
            var t, r = [],
                ...
                a = document.createTreeWalker(e, 4, S, !1);
            for (; t = a.nextNode();) {
    ...
    function L(e, t) {
        ...
        var a = function(e, t) {
            var r = [],
                o = e;
            for (; d(e.parentNode);) e = e.parentNode, o.textContent.trim() !== e.textContent.trim() && (o = e);
        ...
        for (var n = 0, r = e; n < r.length; n += 1) {
            ...
            if (a && o.isConnected) {
                for (var i = 0, s = a; i < s.length; i += 1) {
                    ...
                    u && (o.weglot.setted = !0, R(o, d, u, l, e)), f && (o.weglot.setted = !0, f(o, d, l))
                }
                o.wgResolved = !1
            }
        }
    ...
    function R(e, t, n, r, o) {
        if (1 === e.nodeType) {
            var a = function(e, t, n) {
                ...
                return r.innerHTML = e, P(t, r, n)
            }(t, e, n);
            return e.innerHTML = "", void e.appendChild(a)
        }
        if (x(t) && !x(r)) {
            if (!e.parentNode) return u.warn("Unable to translate some words, please contact support@weglot.com."), void u.warn(e, {
                sendToDatadog: !1
            });
            if (1 === e.parentNode.childNodes.length) return e.parentNode.weglot = e.weglot, void(o ? o.push(e.parentNode) : R(e.parentNode, t, n, r));
            var i = e.closest && e.closest("[data-wg-translation-wrapper]") || e.parentNode.closest("[data-wg-translation-wrapper]");
            if (!i || i.innerHTML !== t) {
                var s = document.createElement("span");
                s.dataset.wgTranslationWrapper = "", s.weglot = e.weglot, e.parentNode.replaceChild(s, e), o ? o.push(s) : R(e.parentNode, t, n, r)
            }
    ...
    function P(e, t, n) {
        ...
        for (var o = t.childNodes.length, a = 0; a < o; a++) {
            var i, s = t.firstChild;
            if (i = I(s)) {
                var c = n[i - 1];
                if (!c) continue;
                var l = c.used ? c.child.cloneNode(!0) : c.child,
                    f = P(l, s, n);
                if (f.contains(l)) return u.error("There is an HTML error in the translation of: " + e.innerHTML.toString()), r;
                l.innerHTML = "", l.appendChild(f), r.appendChild(l), document.createDocumentFragment().appendChild(s), c.used = !0
    ...
    function W(e) {
        ...
        if (e.media_enabled && t.push({
                    ...
                    set: function(e, t, n) {
                        ...
                        if (t === n) {
                            if (e.removeAttribute("data-wgtranslated"), e.isChanged) {
                                ...
                                e.setAttribute("src", a), F(e, a), e.hasAttribute("wgsrcset") && (e.setAttribute("srcset", e.getAttribute("wgsrcset") || e.dataset.srcset), e.removeAttribute("wgsrcset"))
                            }
                        } else r.split("?")[0] !== t && n !== t && (e.setAttribute("src", t), F(e, t), e.hasAttribute("srcset") && (e.setAttribute("wgsrcset", o), e.setAttribute("srcset", "")), e.dataset.wgtranslated = !0, e.isChanged = !0)
                    }
                }
            }, {
                type: 6,
            ...
            var n = U(function() {
                ...
                return r ? r[1] : (u.warn("[Weglot] Unable to get current hostname"), t)
            }());
            t.push({
                type: 10,
                selectors: ["iframe"],
        ...
        if (e.extra_definitions && e.extra_definitions.length)
            for (var r = function() {
                    ...
                    }) : u.warn("Each extra definition option needs at least {attribute,selector} https://bit.ly/2yDsLxy", {
                        sendToDatadog: !1
                    })
                }, o = 0, i = e.extra_definitions; o < i.length; o += 1) r();
        return t
    }
    S.acceptNode = S;
    var H = [];
    ...
    function M(e, r) {
        ...
        var o;
        return Object.assign(n, r), n.document = e, n.mergeNodes = (o = r.translation_engine, t.v2.unshift("#text", "#comment"), Object.keys(t).reduce((function(e, n, r) {
        ...
        })).join(",")), r.merged_selectors_remove && (n.mergedSelectorRemove = r.merged_selectors_remove.map((function(e) {
            return e.value
        })).join(",")), {
            getTextNodes: C,
            setTextNodes: A,
    ...
    B.set = function(e) {
        ...
        if (z && t) {
            var s = i.host,
                c = i.is_connect,
                l = i.subdirectory;
            t = t.replace(/[^+#$&^`|]/g, encodeURIComponent).replace("(", "%28").replace(")", "%29"), n = n.toString().replace(/[^+#$&/:<-[\]-}]/g, encodeURIComponent), !r && c && s && (r = l ? s : s.split("www.").pop());
            var u = r ? ";domain=" + r : "",
                f = a ? ";expires=" + a : "",
                d = ";path=/" + (o || "");
    ...
    var $ = l({
        ...
        V = "https://cdn.weglot.com/projects-settings/",
        G = "preview.weglot.io",
        J = "wglang",
        X = "wg-style-trans",
        Y = "data-wg-notranslate",
        K = "wg-translations",
        Z = "wg-slugs",
        Q = "Shopify",
        ee = "BigCommerce",
        ...
        ie = "Bubble",
        se = "Salesforce",
        ce = ["excluded_blocks", "excluded_blocks_remove", "dynamics", "excluded_paths", "dangerously_force_dynamic", "extra_definitions", "translate_event"],
        le = ["polyfillReady", "languageChanged", "initialized", "start", "switchersReady"],
        ue = {
            button_style: {
                full_name: !0,
                with_name: !0,
        ...
        fe = ["none", "shiny", "square", "circle", "rectangle_mat"],
        de = {};
    ! function(e) {
        var t = function() {
                try {
        ...
        if (function() {
                ...
                var t = e.URL,
                    n = function(t, n) {
                        ...
                        if (i.type = "url", i.value = t, ":" === a.protocol || !/:/.test(a.href) || !i.checkValidity() && !n) throw new TypeError("Invalid URL");
                        ...
                        Object.defineProperty(this, "_updateSearchParams", {
                            ...
                            writable: !1,
                            value: function() {
                                this.search !== f && (f = this.search, l && (c = !1, this.searchParams._fromString(this.search), c = !0))
                            }
                        })
                    },
                    r = n.prototype;
    ...
    var ge = de.URL,
        ...
        _e = pe("querySelectorAll", []),
        he = pe("querySelector", null),
        me = pe("closest", null),
        ve = function(e) {
    ...
    function xe(e, t) {
        ...
        ye(ve(t)), n.id = t, n.type = "text/css", n.styleSheet ? n.styleSheet.cssText = e : n.appendChild(document.createTextNode(e)), document.head && document.head.appendChild(n)
    }
    var Ee = function() {
    ...
    function Pe(e, t, n) {
        return "function" != typeof t ? ($.error("You should provide a callback function as second argument", {
            sendToDatadog: n
        }), !1) : !n && le.indexOf(e) < 0 ? ($.error("No Weglot event is named " + e, {
            sendToDatadog: !1
        }), !1) : (Ae.push({
            name: e,
            callback: t,
    ...
    function Ie(e) {
        ...
        for (var r = Ae.filter((function(t) {
            ...
            try {
                ...
                $.error("Error triggering callback function: " + e, {
                    sendToDatadog: !1
                })
            }
        }
    ...
    function De() {
        if (!a(window.location.hostname) || !document.baseURI) {
            var e = window.location;
            return {
                url: e.href,
                hostname: e.hostname,
    ...
    Re(Ia && Object.keys(Ia).length > 0, "onOptionsReady", (function() {
        if (Ia.dynamicPushState) {
            ...
            history.pushState = function() {
                ...
                e.apply(history, t);
                var r = De();
                Fe.hostname = r.hostname, Fe.pathname = r.pathname, Fe.url = r.url, Ie("onCurrentLocationChanged")
            }
        }
    }));
    var Ue, We = {};
    ...
    function Me() {
        ...
        return We.convertLocale = function(t, n, r, a) {
            if (void 0 === n && (n = e), void 0 === r && (r = s || o), void 0 === a && (a = null), r === t) return n;
            var i = l.position;
            void 0 === i && (i = 0);
            ...
            if (r === o) {
                ...
                if (u) {
                    var h = u.replace(/CODE/g, o),
                        m = new RegExp("^" + h + "$", "g"),
                        v = He(p);
                    p = g.replace(m, v), a && !m.test(g) && (_ = !0, p = a.split("/")[i + 1])
                }
                var y = u && !_ ? 2 : 1;
                return d.slice(0, i + 1).concat([p], d.slice(i + y)).join("/")
            }
            if (t === o && !u) return d.slice(0, i + 1).concat(d.slice(i + 2)).join("/");
    ...
    function Be() {
        ...
        if (Ia.is_connect) {
            ...
            return e ? (Ue = e, e) : Ue = Ia.subdirectory ? ze() : qe()
        }
    ...
    function Ze(e) {
                ...
                return Xe.network.resolved = !0,
                    function(e) {
                        ...
                        try {
                            ...
                            r && r.setItem(Z, JSON.stringify(n))
                        } catch (e) {
                            $.warn(e)
                        }
        ...
        if (Object.keys(Xe.slugs).length) return Xe.slugs;
        try {
            var e = Je({
                type: "local"
            });
            if (!e) return {};
            var t = e.getItem(Z);
            t && (Object.assign(Xe, JSON.parse(t)), Xe.slugs)
        } catch (e) {
            return {}
        }
    }();
    ...
    function nt(e, t) {
        var n = Be(),
            r = new ge(Fe.url);
        Ia.visual_editor && r.searchParams.has("url") && (r = new ge(r.searchParams.get("url"))), r.searchParams.has("lang") && r.searchParams.delete("lang"), tt(e, r);
        var o = function(e) {
            if (Ia.subdirectory) return !1;
    ...
    function it() {
        ...
        if (e) {
            ...
            1 !== t.length && t[0] === t[1] || B.set({
                name: "cart",
                value: t[0],
                domain: at(),
                options: Ia
            })
        } else setTimeout(it, 100)
    }
            ...
            for (var o = e.name, a = e.selector, i = e.testRegex, s = e.event, c = document.querySelectorAll(a.join(",")), l = function() {
                    ...
                    if (i.test(a) && !r.every((function(e) {
                        ...
                        for (var c = 0, l = r; c < l.length; c += 1) {
                            var d = l[c];
                            a = Oe(a, d.name, d.value)
                        }
                        e.setAttribute(o, a), e.wgCheckoutListener && e.removeEventListener(s, e.wgCheckoutListener), t !== Ia.language_from && Ia.fix_shopify_checkout_locale && (e.wgCheckoutListener = function(e) {
                            return e.preventDefault(), e.stopPropagation(), Ia.is_connect && !Ia.subdirectory ? (Je({
                                type: "cookie"
                            }).setItem("wg_checkout_redirect", t), document.location.href = encodeURI((Ia.is_https ? "https:" : "http:") + "//" + Ia.host)) : st(n), !1
                        }, e.addEventListener(s, e.wgCheckoutListener))
                    }
                }, u = 0, f = c; u < f.length; u += 1) l()
        }))
    }
    ...
    function ut(e) {
        var t, n, r, o = e || Be(),
            a = document.getElementById("create_customer") || document.querySelector('form[action="' + (t = o, n = "/account", (Ia.is_connect && t !== Ia.language_from ? ot[n] ? ot[n] : (Ze((function(e) {
                var o = e && e[t] ? et(n, e[t].original) : n;
                r = Ia.subdirectory ? Me().convertLocale(t, o, Ia.language_from) : o
            })), ot[n] = r, r) : n) + '"]')) || "string" == typeof Ia.customer_tag && he(document, Ia.customer_tag);
        if (a) {
        ...
        if (!Ia.visual_editor && !ke()) {
            ...
            if (Je({
                ...
                !1 !== o && r && !a && i === Be() && u.then((function(e) {
                    ...
                    type: "session"
                }).setItem("wg-cart-update-token", s), Je({
                    type: "session"
            ...
            for (var f = document.querySelectorAll('a[href*="/cart/"]'), d = "attributes[lang]=" + t, g = 0, p = f; g < p.length; g += 1) {
                ...
                if (h) {
                    ...
                    m && (h = h.replace(/&?attributes\[lang\]=([a-zA-Z-]+)/g, ""), _.setAttribute("href", h + (m[1] ? "&" : "?") + d))
                }
            }
        }
    }
    ...
    function gt(e) {
        if (Ia.language_from !== e) {
            window.Shopify && (window.Shopify.locale = e), !Ee() && Ia.order_tag && dt(e), ct(e), ft(e);
            var t = document.querySelectorAll("[data-wg-only-display]");
            t.length && $e(t, e), Ia.customer_tag && ut(e)
        }
    }
    Pe("onCurrentLocationChanged", (function() {
        ot = {}
    ...
    function yt(e) {
        ...
        var r = e || _t(Be());
        return void 0 !== mt[r] && mt.currentLang === r || (mt.currentLang = r, Ia.injectedData && Ia.injectedData.originalPath && (n = Ia.injectedData.originalPath.toLowerCase()), t.some((function(e) {
            var t = e.type,
                o = e.value,
            ...
            var l = vt(n);
            if (s && !t.startsWith("NOT") ? l.MATCH_REGEX(s) : l[t](o)) return mt[r] = c, !0;
            var u = n;
            try {
            ...
            if (u !== n) {
                var f = vt(u);
                return (s && !t.startsWith("NOT") ? f.MATCH_REGEX(s) : f[t](o)) ? (mt[r] = c, !0) : void 0
            }
        }))), mt[r]
    }
    ...
    function wt() {
        if (ht) return ht;
        if (!Ia.api_key) return $.warn("Weglot must be initialized to use it.", {
            sendToDatadog: !1
        }), [];
        ...
        })), e.length || $.log("No public language available.", {
            sendToDatadog: !1
        }), ht
    }
    ...
    function bt() {
        var e = Je().getItem(J);
        if (e && wt().includes(e)) return e
    }
    Pe("onCurrentLocationChanged", (function() {
        mt = {}
    }), !0), Pe("onCurrentLocationChanged", (function() {
        ht = null
    }), !0);
    var kt = function(e) {
            return e && Je().setItem(J, e)
        },
        xt = [{
            condition: [{
                type: "TECHNOLOGY_ID",
    ...
    if (St.getItem(K)) try {
        Ct = JSON.parse(St.getItem(K)), Object.keys(Ct).forEach((function(e) {
    ...
    function Nt(e, t, n, r) {
        var o, a = Lt(e);
        a ? (a[r] = n, a.createdTime = (new Date).getTime(), a.t = t) : Ct[e] = ((o = {})[r] = n, o.createdTime = (new Date).getTime(), o.t = t, o), Ot[r] || (Ot[r] = {}), Ot[r][n] = e, Ia.cache && Se(Tt)()
    }
    var Tt = function() {
        return Ct && St.setItem(K, JSON.stringify(Ct))
    };
    var jt = [],
        At = new Set,
        Rt = !1,
    ...
    function Dt(e) {
        return we(e).replace(/<([^>]+)\/>/g, "<$1>").replace(/[\n\r]+/g, "")
    }
    ...
    function Ut(e) {
        ...
        return !t.weglot || !t.weglot.content || !t.weglot.content.some((function(e) {
            var t, r = e.original,
                o = e.translations;
            return r === n || (t = o, Object.keys(t).map((function(e) {
                return t[e]
            }))).includes(we(n))
        }))
    }
    ...
    function Wt(e) {
        for (var t = [], n = 0, r = e; n < r.length; n += 1) {
            var o = r[n]; - 1 === jt.indexOf(o) && t.push(o)
        }
        return [].push.apply(jt, t), t
    }

    function Ht(e, t) {
        void 0 === e && (e = jt), void 0 === t && (t = {});
        ...
        if (n && o && !Rt) {
            ...
            void 0 === a && (a = []), a.forEach((function(e) {
                return It(e)
            })), Rt = !0
        }
        for (var i = [], s = {}, c = 0, l = e; c < l.length; c += 1)
            for (var u = 0, f = l[c].weglot.content; u < f.length; u += 1) {
                var d = f[u],
                    g = d.original,
                    p = d.type;
                s[g] || (n && Pt(g) || (s[g] = !0, i.push(Object.assign({}, {
                    t: p,
                    w: g
                }, t.label && {
                    l: t.label
    ...
    function Mt(e, t, n) {
        if (void 0 === t && (t = Be()), void 0 === n && (n = jt), e && e.to_words && e.to_words.length)
            for (var r = e.from_words, o = e.to_words, a = 0, i = n; a < i.length; a += 1)
                for (var s = 0, c = i[a].weglot.content || {}; s < c.length; s += 1) {
                    ...
                    if (-1 !== d && !f[t]) {
                        ...
                        Ia.prevent_retranslation && It(g), f[t] = g
                    }
                }
        var p;
        try {
    ...
    function qt(e, t) {
        ...
        if (!Ia.visual_editor) {
            if (n = function(e, t) {
                    ...
                    return e.forEach((function(e) {
                        var a = Lt(e.w);
                        a && a[t] ? (n.push(a[t]), r.push(we(e.w))) : o.push(e)
                    })), {
                        cachedWords: {
                            to_words: n,
                            from_words: r
                ...
                }(o, r), i = n.newWords, (a = n.cachedWords).to_words.length && !t.search) {
        ...
        return i.length ? (e.request_url = function() {
            var e = function() {
                if (Ia.visual_editor) return new ge(Fe.url);
                var e = Ia.technology_name,
                    t = Ia.injectedData;
                if (e === re) return new ge(window.location.href);
                if (t && t.originalCanonicalUrl) try {
                    return new ge(t.originalCanonicalUrl)
                } catch (e) {}
                var n = document.querySelector("link[rel='canonical'][href]");
                if (n) try {
                    return new ge(n.href)
                } catch (e) {}
                return new ge(window.location.href)
            }();
            e.pathname = (t = e.pathname, t.split("/").filter((function(e) {
            ...
            return fetch(r, {
                ...
                if (!e || !e.to_words) throw $.warn(e), Error("An error occurred, please try again later");
                return e
            }))
        }(e).then((function(e) {
    ...
    function $t(e) {
        var t = "https://api.weglot.com/pageviews?api_key=" + Ia.api_key,
            n = JSON.stringify({
                url: e || Fe.url,
                language: Be(),
    ...
    function Vt(e, t, n) {
        ...
        return n.title && (r.title = document.title), qt(r, n)
    }

    function Gt(e, t) {
        if ("string" != typeof e || "function" != typeof t) return !1;
        var n = Be();
        return n === Ia.language_from ? (t(e), !1) : (qt({
            l_from: n,
    ...
    function Xt(e) {
        ...
        if (r && r.length && Array.isArray(r))
            for (var i = 0, s = _e(n, r.join(",")); i < s.length; i += 1) {
                var c = s[i],
                    l = c.src;
                if (!l) return;
                if (c.weglot || (c.weglot = {}), !l.includes("proxy.weglot.com/")) {
                    if (c.weglot.originalFrameSrc || (c.weglot.originalFrameSrc = l), t === a) return;
                    try {
        ...
        if (e.data && "null" !== e.origin) {
            ...
            if (n) {
                if ("Weglot.iframe" === n) {
                    ...
                    return e.source.postMessage(o, e.origin), void Jt.push(e.source)
                }
                "Weglot.setLanguage" !== n || ma(r)
            }
        }
    }
    var Zt, Qt, en, tn, nn, rn, on, an, sn = {},
        cn = [],
    ...
    function dn(e, t, n) {
        ...
        if (arguments.length > 2 && (i.children = arguments.length > 3 ? Zt.call(arguments, 2) : n), "function" == typeof e && null != e.defaultProps)
    ...
    function hn(e, t) {
        if (null == t) return e.__ ? hn(e.__, e.__.__k.indexOf(e) + 1) : null;
    ...
    function yn() {
        var e, t, n, r, o, a, i, s;
        for (tn.sort(on); e = tn.shift();) e.__d && (t = tn.length, r = void 0, o = void 0, i = (a = (n = e).__v).__e, (s = n.__P) && (r = [], (o = un({}, a)).__v = a.__v + 1, Nn(s, a, o, n.__n, void 0 !== s.ownerSVGElement, null != a.__h ? [i] : null, r, null == i ? hn(a) : i, a.__h), Tn(r, a), a.__e != i && mn(a)), tn.length > t && tn.sort(on));
        yn.__r = 0
    }

    function wn(e, t, n, r, o, a, i, s, c, l) {
        var u, f, d, g, p, _, h, m = r && r.__k || cn,
            v = m.length;
        for (n.__k = [], u = 0; u < t.length; u++)
            if (null != (g = n.__k[u] = null == (g = t[u]) || "boolean" == typeof g || "function" == typeof g ? null : "string" == typeof g || "number" == typeof g || "bigint" == typeof g ? gn(null, g, null, null, g) : Array.isArray(g) ? gn(pn, {
                ...
                if (g.__ = n, g.__b = n.__b + 1, null === (d = m[u]) || d && g.key == d.key && g.type === d.type) m[u] = void 0;
                else
                    for (f = 0; f < v; f++) {
                ...
                Nn(e, g, d = d || sn, o, a, i, s, c, l), p = g.__e, (f = g.ref) && d.ref != f && (h || (h = []), d.ref && h.push(d.ref, null, g), h.push(f, g.__c || p, g)), null != p ? (null == _ && (_ = p), "function" == typeof g.type && g.__k === d.__k ? g.__d = c = bn(g, c, e) : c = xn(e, g, d, m, p, c), "function" == typeof n.type && (n.__d = c)) : c && d.__e == c && c.parentNode != e && (c = hn(d))
            }
        for (n.__e = _, u = v; u--;) null != m[u] && ("function" == typeof n.type && null != m[u].__e && m[u].__e == n.__d && (n.__d = En(r).nextSibling), Rn(m[u], m[u]));
        if (h)
            for (u = 0; u < h.length; u++) An(h[u], h[++u], h[++u])
    }

    function bn(e, t, n) {
        for (var r, o = e.__k, a = 0; o && a < o.length; a++)(r = o[a]) && (r.__ = e, t = "function" == typeof r.type ? bn(r, t, n) : xn(n, r, r, o, r.__e, t));
        return t
    }
        ...
        e: if ("style" === t)
            if ("string" == typeof n) e.style.cssText = n;
                ...
                if ("string" == typeof r && (e.style.cssText = r = ""), r)
                    for (t in r) n && t in n || Cn(e.style, t, "");
                if (n)
                    for (t in n) r && n[t] === r[t] || Cn(e.style, t, n[t])
            }
        else if ("o" === t[0] && "n" === t[1]) a = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + a] = n, n ? r || e.addEventListener(t, a ? Ln : Sn, a) : e.removeEventListener(t, a ? Ln : Sn, a);
    ...
    function Nn(e, t, n, r, o, a, i, s, c) {
        ...
        try {
            e: if ("function" == typeof E) {
                if (h = t.props, m = (l = E.contextType) && r[l.__c], v = l ? m ? m.props.value : l.__ : r, n.__c ? _ = (u = t.__c = n.__c).__ = u.__E : ("prototype" in E && E.prototype.render ? t.__c = u = new E(h, v) : (t.__c = u = new _n(h, v), u.constructor = E, u.render = Pn), m && m.sub(u), u.props = h, u.state || (u.state = {}), u.context = v, u.__n = r, f = u.__d = !0, u.__h = [], u._sb = []), null == u.__s && (u.__s = u.state), null != E.getDerivedStateFromProps && (u.__s == u.state && (u.__s = un({}, u.__s)), un(u.__s, E.getDerivedStateFromProps(h, u.__s))), d = u.props, g = u.state, u.__v = t, f) null == E.getDerivedStateFromProps && null != u.componentWillMount && u.componentWillMount(), null != u.componentDidMount && u.__h.push(u.componentDidMount);
                else {
                    if (null == E.getDerivedStateFromProps && h !== d && null != u.componentWillReceiveProps && u.componentWillReceiveProps(h, v), !u.__e && null != u.shouldComponentUpdate && !1 === u.shouldComponentUpdate(h, u.__s, v) || t.__v === n.__v) {
                        for (t.__v !== n.__v && (u.props = h, u.state = u.__s, u.__d = !1), u.__e = !1, t.__e = n.__e, t.__k = n.__k, t.__k.forEach((function(e) {
                                e && (e.__ = t)
                            })), y = 0; y < u._sb.length; y++) u.__h.push(u._sb[y]);
                        u._sb = [], u.__h.length && i.push(u);
                        break e
                    }
                    null != u.componentWillUpdate && u.componentWillUpdate(h, u.__s, v), null != u.componentDidUpdate && u.__h.push((function() {
                        u.componentDidUpdate(d, g, p)
                    }))
                }
                if (u.context = v, u.props = h, u.__P = e, w = Qt.__r, b = 0, "prototype" in E && E.prototype.render) {
                    for (u.state = u.__s, u.__d = !1, w && w(t), l = u.render(u.props, u.state, u.context), k = 0; k < u._sb.length; k++) u.__h.push(u._sb[k]);
                    u._sb = []
                } else
                    do {
                        u.__d = !1, w && w(t), l = u.render(u.props, u.state, u.context), u.state = u.__s
                    } while (u.__d && ++b < 25);
                u.state = u.__s, null != u.getChildContext && (r = un(un({}, r), u.getChildContext())), f || null == u.getSnapshotBeforeUpdate || (p = u.getSnapshotBeforeUpdate(d, g)), x = null != l && l.type === pn && null == l.key ? l.props.children : l, wn(e, Array.isArray(x) ? x : [x], t, n, r, o, a, i, s, c), u.base = t.__e, t.__h = null, u.__h.length && i.push(u), _ && (u.__E = u.__ = null), u.__e = !1
            } else null == a && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = jn(n.__e, t, n, r, o, a, i, c);
            (l = Qt.diffed) && l(t)
        }
        catch (e) {
            t.__v = null, (c || null != a) && (t.__e = s, t.__h = !!c, a[a.indexOf(s)] = null), Qt.__e(e, t, n)
        }
    }

    function Tn(e, t) {
        Qt.__c && Qt.__c(t, e), e.some((function(t) {
            try {
    ...
    function jn(e, t, n, r, o, a, i, s) {
        ...
        if (null == e) {
            ...
            e = o ? document.createElementNS("http://www.w3.org/2000/svg", g) : document.createElement(g, d.is && d), a = null, s = !1
        }
        if (null === g) f === d || s && e.data === d || (e.data = d);
        else {
            if (a = a && Zt.call(e.childNodes), l = (f = n.props || sn).dangerouslySetInnerHTML, u = d.dangerouslySetInnerHTML, !s) {
                if (null != a)
            ...
            if (function(e, t, n, r, o) {
                    var a;
                    for (a in n) "children" === a || "key" === a || a in t || On(e, a, null, n[a], r);
                    for (a in t) o && "function" != typeof t[a] || "children" === a || "key" === a || "value" === a || "checked" === a || n[a] === t[a] || On(e, a, t[a], n[a], r)
                }(e, d, f, o, s), u) t.__k = [];
            else if (p = t.props.children, wn(e, Array.isArray(p) ? p : [p], t, n, r, o && "foreignObject" !== g, a, i, a ? a[0] : n.__k && hn(n, 0), s), null != a)
                for (p = a.length; p--;) null != a[p] && fn(a[p]);
            s || ("value" in d && void 0 !== (p = d.value) && (p !== e.value || "progress" === g && !p || "option" === g && p !== f.value) && On(e, "value", p, f.value, !1), "checked" in d && void 0 !== (p = d.checked) && p !== e.checked && On(e, "checked", p, f.checked, !1))
        }
        return e
    }
    ...
    function Rn(e, t, n) {
        var r, o;
        if (Qt.unmount && Qt.unmount(e), (r = e.ref) && (r.current && r.current !== e.__e || An(r, null, t)), null != (r = e.__c)) {
        ...
        if (r = e.__k)
            for (o = 0; o < r.length; o++) r[o] && Rn(r[o], t, n || "function" != typeof e.type);
        n || null == e.__e || fn(e.__e), e.__ = e.__e = e.__d = void 0
    }
    ...
    function In(e) {
        ...
        if ("string" == typeof e || "number" == typeof e) r += e;
            ...
            if (Array.isArray(e)) {
                var o = e.length;
                for (t = 0; t < o; t++) e[t] && (n = In(e[t])) && (r && (r += " "), r += n)
            } else
    ...
    }, en = 0, _n.prototype.setState = function(e, t) {
        var n;
        n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = un({}, this.state), "function" == typeof e && (e = e(un({}, n), this.props)), e && un(n, e), null != e && this.__v && (t && this._sb.push(t), vn(this))
    }, _n.prototype.forceUpdate = function(e) {
        this.__v && (this.__e = !0, e && this.__h.push(e), vn(this))
    }, _n.prototype.render = pn, tn = [], rn = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, on = function(e, t) {
        return e.__v.__b - t.__v.__b
    }, yn.__r = 0, an = 0;
    var Dn, Fn, Un, Wn, Hn = 0,
        Mn = [],
        qn = [],
        zn = Qt.__b,
        Bn = Qt.__r,
    ...
    function Xn(e) {
        return Hn = 1,
            function(e, t, n) {
                var r = Jn(Dn++, 2);
                if (r.t = e, !r.__c && (r.__ = [n ? n(t) : or(void 0, t), function(e) {
    ...
    function Yn(e, t) {
        var n = Jn(Dn++, 3);
        !Qt.__s && rr(n.__H, t) && (n.__ = e, n.i = t, Fn.__H.__h.push(n))
    }
    ...
    function Kn(e) {
        return Hn = 5,
            function(e, t) {
                var n = Jn(Dn++, 7);
                return rr(n.__H, t) ? (n.__V = e(), n.i = t, n.__h = e, n.__V) : n.__
            }((function() {
                return {
                    current: e
                }
    ...
    function Zn() {
        for (var e; e = Mn.shift();)
            if (e.__P && e.__H) try {
                e.__H.__h.forEach(tr), e.__H.__h.forEach(nr), e.__H.__h = []
            } catch (t) {
    ...
    Qt.__b = function(e) {
        ...
        Bn && Bn(e), Dn = 0;
        var t = (Fn = e.__c).__H;
        t && (Un === Fn ? (t.__h = [], Fn.__h = [], t.__.forEach((function(e) {
            e.__N && (e.__ = e.__N), e.__V = qn, e.__N = e.i = void 0
        }))) : (t.__h.forEach(tr), t.__h.forEach(nr), t.__h = [])), Un = Fn
    }, Qt.diffed = function(e) {
        $n && $n(e);
        var t = e.__c;
        t && t.__H && (t.__H.__h.length && (1 !== Mn.push(t) && Wn === Qt.requestAnimationFrame || ((Wn = Qt.requestAnimationFrame) || er)(Zn)), t.__H.__.forEach((function(e) {
            e.i && (e.__H = e.i), e.__V !== qn && (e.__ = e.__V), e.i = void 0, e.__V = qn
        }))), Un = Fn = null
    }, Qt.__c = function(e, t) {
        t.some((function(e) {
            try {
                e.__h.forEach(tr), e.__h = e.__h.filter((function(e) {
                    return !e.__ || nr(e)
                }))
            } catch (n) {
                t.some((function(e) {
    ...
    function tr(e) {
        var t = Fn,
            n = e.__c;
        "function" == typeof n && (e.__c = void 0, n()), Fn = t
    }
    ...
    function sr(e) {
        this.props = e
    }(sr.prototype = new _n).isPureReactComponent = !0, sr.prototype.shouldComponentUpdate = function(e, t) {
    ...
    function dr(e, t, n) {
        ...
        })), e.__c.__H = null), null != (e = ar({}, e)).__c && (e.__c.__P === n && (e.__c.__P = t), e.__c = null), e.__k = e.__k && e.__k.map((function(e) {
            return dr(e, t, n)
        }))), e
    }
    ...
    Qt.unmount = function(e) {
        var t = e.__c;
        t && t.__R && t.__R(), t && !0 === e.__h && (e.type = null), fr && fr(e)
        ...
        return o && (o.__h = null), [dn(pn, null, t.__a ? null : e.children), o]
    };
    ...
    (hr.prototype = new _n).__a = function(e) {
        ...
        return r[0]++,
            function(o) {
                var a = function() {
                    t.props.revealOrder ? (r.push(o), mr(t, e, r)) : o()
                };
                n ? n(a) : a()
            }
    ...
    Qt.event = function(e) {
        return Er && (e = Er(e)), e.persist = Cr, e.isPropagationStopped = Or, e.isDefaultPrevented = Sr, e.nativeEvent = e
    };
    var Lr = {
            enumerable: !1,
            configurable: !0,
        ...
        "string" == typeof e.type && function(e) {
            ...
            for (var o in t) {
                ...
                if (!("value" === o && "defaultValue" in t && null == a || kr && "children" === o && "noscript" === n || "class" === o || "className" === o)) {
                    var i = o.toLowerCase();
                    "defaultValue" === o && "value" in t && null == t.value ? o = "value" : "download" === o && !0 === a ? a = "" : "ondoubleclick" === i ? o = "ondblclick" : "onchange" !== i || "input" !== n && "textarea" !== n || xr(t.type) ? "onfocus" === i ? o = "onfocusin" : "onblur" === i ? o = "onfocusout" : wr.test(o) ? o = i : -1 === n.indexOf("-") && yr.test(o) ? o = o.replace(br, "-$&").toLowerCase() : null === a && (a = void 0) : i = o = "oninput", "oninput" === i && r[o = i] && (o = "oninputCapture"), r[o] = a
                }
            }
            ...
            }))), t.class && !t.className ? (r.class = t.class, Object.defineProperty(r, "className", Lr)) : (t.className && !t.class || t.class && t.className) && (r.class = r.className = t.className), e.props = r
        }(e), e.$$typeof = vr, Nr && Nr(e)
    };
    var Tr = Qt.__r;
    Qt.__r = function(e) {
        Tr && Tr(e), e.__c
                ...
                o = function(e, t) {
                    function n(e) {
                        var n = this.props.ref,
                            r = n == e.ref;
                        return !r && n && (n.call ? n(null) : n.current = null), t ? !t(this.props, e) || !r : ir(this.props, e)
                    }
                    ...
                    return t.$$typeof = lr, t.render = t, t.prototype.isReactComponent = t.__f = !0, t.displayName = "ForwardRef(" + (e.displayName || e.name) + ")", t
                }((function(t, r) {
                    var o = t || {},
                        a = o.children,
                        i = o.as;
                    ...
                    var c = function(e, t) {
                        ...
                        u = function(e) {
                            var t = Fn.context[e.__c],
                                n = Jn(Dn++, 9);
                            return n.c = e, t ? (null == n.__ && (n.__ = !0, t.sub(Fn)), t.props.value) : e.__
                        }(Rr);
    ...
    function Ir(e) {
        ...
        var r = e.children,
            o = function(e) {
                var t = Jn(Dn++, 10),
                    n = Xn();
                return t.__ = e, Fn.componentDidCatch || (Fn.componentDidCatch = function(e, r) {
                    t.__ && t.__(e, r), n[1](e)
                }), [n[0], function() {
                    n[1](void 0)
                }]
    ...
    function no(e, t, n) {
        ...
        void 0 === i && (i = {});
        var s = e.colors;
        return void 0 === s && (s = {}), Yn((function() {
            var e = i.size_scale;
            if (e && 1 !== e) {
                var r, o, c, l, u = (r = t({
                    style: i,
                    colors: s
                }), o = n, c = Ia.button_style && Ia.button_style.custom_css, l = r.map((function(e) {
                    var t = e.selector,
                        n = e.declarations;
    ...
    function ro(e) {
        ...
        function k() {
            ...
            void 0 === t && (t = 0);
            var n = e.left;
            void 0 === n && (n = 0), b(t > window.innerHeight / 2), v(n > window.innerWidth / 2), l(!0)
        }
        ...
        function C(e) {
            if (Ia.switcher_editor) return l(!1);
            var t;
            i(e), t = e, "WordPress" === Ia.technology_name && Ia.injectedData && !Ia.is_connect ? Gr(t, (function(e) {
                a(window.location.hostname) ? window.dispatchEvent(new CustomEvent("veLanguageChangeUrl", {
                    detail: {
                        targetUrl: e
                    }
                })) : window.location.replace(e)
            })) : window.Weglot.switchTo(t), l(!1)
        }
        return Yn((function() {
            ...
            handleKeyDown: function(e) {
                return e.keyCode === Jr ? (e.preventDefault(), p && C(p), E()) : e.keyCode === Kr || e.keyCode === Yr ? (e.preventDefault(), void
                    function(e) {
                        var t = e === Kr ? "down" : "up",
                            n = d.slice(-1).pop(),
                            r = d[0],
                            o = Qr(u.current).bottom;
                        void 0 === o && (o = 0);
                        var a = o > window.innerHeight / 2;
                        if (!p || !c) {
                            return _("down" === t ? r : n), void(!c && ("up" === t && a || "down" === t && !a) && k())
                        }
                        if (!a && "up" === t && p === r || a && "down" === t && p === n) return void E();
                        var i = "up" === t ? -1 : 1,
                            s = d.indexOf(p) + i;
                        if (s === d.length || -1 === s) return;
                        _(d[s])
                    }(e.keyCode)) : void(e.keyCode === Xr && c && (e.preventDefault(), E()))
            },
            switchLanguage: C,
            toggleOpen: E
        }
    ...
    var co, lo, uo, fo = "default",
        go = function(e, t) {
            return function(n) {
                ...
                return function(e, t, n) {
                    var r, o, a;
                    Qt.__ && Qt.__(e, t), o = (r = "function" == typeof n) ? null : t.__k, a = [], Nn(t, e = (!r && n || t).__k = dn(pn, null, [e]), o || sn, sn, void 0 !== t.ownerSVGElement, !r && n ? [n] : o ? null : t.firstChild ? Zt.call(t.childNodes) : null, a, !r && n ? n : o ? o.__e : t.firstChild, r), Tn(a, e)
                }(dn(Ir, {
                    logger: Hr.error,
                    displayError: !1
                }, dn(e, {
                ...
                })), f), f.classList.add("weglot-container"), f
            }
        }((function(e) {
            var t = e.style,
                n = e.opts,
                ...
                m = function(e) {
                    ...
                    return Yn((function() {
                        if (t) return window.addEventListener("resize", s),
                            function() {
            ...
            var v = Ia.switcher_editor,
                ...
                x = Ia.button_style && /background-position/i.test(Ia.button_style.custom_css) && !Ia.languages.some((function(e) {
                    return e.custom_flag
                })),
                E = function() {
                    for (var e, t, n = arguments, r = 0, o = "", a = arguments.length; r < a; r++)(e = n[r]) && (t = In(e)) && (o && (o += " "), o += t);
                    return o
                }({
                    open: o,
                    closed: !o,
    ...
    function ho(e, t) {
        if (void 0 === t && (t = document.documentElement), e && !e.ready) {
            ...
            var o = function(e, t) {
                    ...
                    var o = _e(t, n);
                    if (!o.length) return {
                        error: Ce(n) ? "The provided target is not on this page." : "The provided target is not a valid CSS selector."
                    };
                    var a = _e(t, r);
            ...
            if (!a) {
                ...
                if (l.weglotSwitcher = e, _o.push(l), c) return l.classList.add("wg-default"), document.body.appendChild(l), e.ready = !0, l;
                l.setAttribute("data-switcher-id", String(++po)), l.id = "weglot-switcher-" + po, l.setAttribute("data-switcher-style-opt", JSON.stringify(n)), i.insertBefore(l, s), e.ready = !0;
    ...
    function mo(e) {
        var t = e.name,
            n = e.hash;
        if (void 0 === n && (n = null), he(document.documentElement, "script#weglot-switcher-" + t)) return !1;
        var r = !Ia.switcher_editor && n ? t + "." + n : t,
            o = document.getElementsByTagName("head")[0] || document.documentElement,
            a = document.createElement("script");
        return a.type = "text/javascript", a.src = "https://cdn.weglot.com/switchers/" + r + ".min.js", a.id = "weglot-switcher-" + t, o.insertBefore(a, o.firstChild), !0
    }

    function vo() {
        co || Ie("switchersReady", Be()), co = !0, clearTimeout(uo), lo && lo.parentNode.removeChild(lo)
    }

    function yo(e) {
        if (void 0 === e && (e = document), !(wt().length < 2 || Ia.hide_switcher || Ia.switcher_editor)) {
            ...
            (function(e) {
                ...
                if (0 === _e(e, ['a[href^="#Weglot-"]', 'a[href*="change-language.weglot.com/"]'].concat(t).join(",")).length) return;
                ...
                return Pe("languageChanged", (function(e) {
                    for (var t = 0, n = wa; t < n.length; t += 1) {
                        ...
                        if (o === e)
                            for (var i = 0, s = a; i < s.length; i += 1) {
                                var c = s[i];
                                c.classList.add("weglot-link--active"), Ia.linkHooksConfig && Ia.linkHooksConfig.onLinkActive && Ia.linkHooksConfig.onLinkActive(c)
                            } else
                                for (var l = 0, u = a; l < u.length; l += 1) {
                                    var f = u[l];
                                    f.classList.remove("weglot-link--active"), Ia.linkHooksConfig && Ia.linkHooksConfig.offLinkActive && Ia.linkHooksConfig.offLinkActive(f)
                                }
                    }
                }), !0), n
            })(t) && vo();
            ...
            if (n.length) {
                for (var r = 0, o = n; r < o.length; r += 1) {
                    ...
                    i.classList.add("weglot_here"), a.parentNode.insertBefore(i, a), ye(a)
                }
                vo()
            }
    ...
    Pe("onCurrentLocationChanged", (function() {
        _o.forEach((function(e) {
            ...
            }(), co = null, lo = null, po = 0, Ia.button_style.ready = !1, Ia.switchers.map((function(e) {
                return e.ready = !1
            })), yo()
    }), !0);
    var wo = 0;
    ...
    function bo() {
        ...
        Ia.translate_event.forEach((function(t) {
            for (var n = _e(document.body, t.selector), r = function() {
                    var n = a[o];
                    if (n.alreadyListeningEventInput) return !n.alreadyListeningEventInput.isConnected && wo < 10 && (wo++, n.parentNode.insertBefore(n.alreadyListeningEventInput, n.nextSibling)), {};
                    var r = n.cloneNode(!0);
                    if (!r) return {};
                    ...
                    var i = Se((function(e) {
                        13 === e.keyCode && e.target.form ? e.target.form.dispatchEvent(new Event("submit")) : Gt(e.target.value, (function(e) {
                            ...
                            o.initEvent("focus", !0, !1), n.dispatchEvent(o), o.initEvent(r, !0, !1), n.dispatchEvent(o)
                        }))
                    }), 400);
    ...
    function xo(e) {
        if (Ia.translate_shadow_roots) {
            e || (e = _e(document, Ia.dynamics.map((function(e) {
                return e.value
            })).join(",")));
    ...
    function To(e, t) {
        ...
        for (var n = 0, r = t; n < r.length; n += 1) {
            var a = r[n];
            1 === a.nodeType && Oo.push(a)
        }
        Oo.length && (Eo = setTimeout((function() {
            yo(e), bo(), Ia.subdomain && function(e) {
                var t = window.location.hostname;
                if (-1 !== [Ia.host].concat(o).indexOf(t)) return;
                for (var n = 0, r = e; n < r.length; n += 1)
                    for (var a = r[n], i = 0, s = _e(a, "[href]"); i < s.length; i += 1) {
                        var c = s[i];
                        if (!v(c)) {
                            var l = c.getAttribute("href");
                            l && l.includes("//" + Ia.host) && c.setAttribute("href", l.replace(Ia.host, t))
                        }
                    }
            }(Oo), Ia.proxify_iframes && Ia.proxify_iframes.length && Oo.forEach((function(e) {
                return Xt({
                    node: e
                })
            })), xo(Oo), je("onDynamicDetected"), Oo = []
        }), 100))
    }
                    ...
                    var n = [],
                        r = e.filter((function(e) {
                            ...
                            return i ? (n.push(i), !1) : r.length ? (setTimeout((function() {
                                return To(a, r)
                            })), !Co || !a || !me(a, Co)) : !So.includes(e.attributeName) && t(a) && ("characterData" === o || "attributes" === o)
                        }));
                    if (n.length)
                    ...
                    for (var r = [], o = function(e) {
                            ...
                            if (e.wgParsedHTML !== n) {
                                ...
                                for (var o = Ft(e, (function(e) {
                                    ...
                                    var s = i[a];
                                    Ia.ignoreDynamicFragments && !document.body.contains(s) || (s.weglot.dynamic || (s.weglot.dynamic = 0), s.weglot.dynamic++, r.push(s))
                                }
                                return null
                            }
                            ...
                            case "childList":
                                ...
                                for (var g = 0, p = f; g < p.length; g += 1) {
                                    ...
                                    for (var m = 0; m < h.length; m++) {
                                        var y = h[m];
                                        t(y) && Le(y) && !v(y) && (o(y.contentWindow.document), Ro(y.contentWindow.document))
                                    }
                                }
                        }
                    }
    ...
    function Po(e) {
        return !(!Ia.dynamics || 0 === Ia.dynamics.length) && (e && e.closest || (e = e.parentNode), e && e.closest && me(e, Ia.dynamics.map((function(e) {
            return e.value
        })).join(", ")))
    }
    var Io = {
    ...
    function Do(e) {
        ...
        if (t !== Ia.language_from) {
            if (Io.times = Io.times.filter((function(e) {
                ...
                })), Io.times.length && (Io.timeout || Io.times.length >= 10)) return Io.nodes = Io.nodes.concat(e), void(Io.timeout = setTimeout((function() {
                return Do()
            }), 1e3));
            Io.timeout = null, Io.times.push(Date.now());
            var n = Io.nodes.concat(e);
            return Io.nodes = [], Vt(Ht(n), t, {
                title: !1,
                cdn: !0,
                nodes: n
            }).then((function(e) {
    ...
    function Wo() {
        if (window.location.search.indexOf("no_redirect=true") > -1) Ho(Be());
                ...
                type: "cookie"
            }).getItem("WG_CHOOSE_ORIGINAL") || Ee() || Ia.visual_editor)) {
            var e = Uo();
    ...
    function qo() {
        var e = ve("wg_progress").firstElementChild,
    ...
    function zo(e) {
        clearInterval(e), ye(ve("wg_progress"))
    }
    var Bo = function(e, t) {
    ...
    var Vo = $o,
        ...
        ea = function(e) {
            var t = {},
                ...
                r = {
                    addEventListener: function(e, r, o) {
                        t[e] = n(e), t[e].indexOf(r) >= 0 || (o = void 0 === o ? t[e].length : o, t[e].splice(o, 0, r))
                    },
                    removeEventListener: function(e, r) {
                        if (void 0 !== e) {
                            void 0 === r && (t[e] = []);
                            var o = n(e).indexOf(r); - 1 !== o && n(e).splice(o, 1)
                        } else t = {}
                    },
                    dispatchEvent: function() {
                        var t = Bo(arguments),
                            o = t.shift();
                        e || (t[0] = Ko(t[0], Qo(o)), Object.defineProperty(t[0], "target", {
                            writable: !1,
                            value: this
                        }));
                        var a = r["on" + o];
            ...
            return e && (r.listeners = function(e) {
                return Bo(n(e))
            }, r.on = r.addEventListener, r.off = r.removeEventListener, r.fire = r.dispatchEvent, r.once = function(e, t) {
                var n = function() {
        ...
        aa = function() {
            var e = new oa,
                ...
                i = 0,
                s = function() {
                    if (a.status = n || e.status, -1 !== n && (a.statusText = e.statusText), -1 === n);
                    else {
                ...
                l = function() {
                    r || d.dispatchEvent("load", {}), d.dispatchEvent("loadend", {}), r && (d.readyState = 0)
                },
                u = function(e) {
                    for (; e > i && i < 4;) d.readyState = ++i, 1 === i && d.dispatchEvent("loadstart", {}), 2 === i && c(), 4 === i && (c(), "text" in a && (d.responseText = a.text), "xml" in a && (d.responseXML = a.xml), "data" in a && (d.response = a.data), "finalUrl" in a && (d.responseURL = a.finalUrl)), d.dispatchEvent("readystatechange", {}), 4 === i && (!1 === t.async ? l() : setTimeout(l, 0))
                },
                f = function(e) {
                    if (4 === e) {
                        var n = na.listeners("after"),
                            r = function() {
                                if (n.length > 0) {
                                    var e = n.shift();
                                    2 === e.length ? (e(t, a), r()) : 3 === e.length && t.async ? e(t, a, r) : r()
                                } else u(4)
                            };
                        r()
                    } else u(e)
                ...
                d = ea();
            t.xhr = d, e.onreadystatechange = function(t) {
                try {
                    2 === e.readyState && s()
                } catch (e) {}
                4 === e.readyState && (o = !1, s(), function() {
                    if (e.responseType && "text" !== e.responseType) "document" === e.responseType ? (a.xml = e.responseXML, a.data = e.responseXML) : a.data = e.response;
                    else {
            ...
            d.addEventListener("error", g), d.addEventListener("timeout", g), d.addEventListener("abort", g), d.addEventListener("progress", (function(t) {
                i < 3 ? f(3) : e.readyState <= 3 && d.dispatchEvent("readystatechange", {})
            })), "withCredentials" in e && (d.withCredentials = !1), d.status = 0;
            for (var p = 0, _ = Array.from(Xo.concat(Jo)); p < _.length; p += 1) {
                var h = _[p];
                d["on" + h] = null
            }
            if (d.open = function(e, n, s, c, l) {
                    i = 0, r = !1, o = !1, t.headers = {}, t.headerNames = {}, t.status = 0, t.method = e, t.url = n, t.async = !1 !== s, t.user = c, t.pass = l, (a = {}).headers = {}, f(1)
                }, d.send = function(n) {
                    for (var r, i, s = 0, c = ["type", "timeout", "withCredentials"]; s < c.length; s += 1)(i = "type" === (r = c[s]) ? "responseType" : r) in d && (t[r] = d[i]);
                    t.body = n;
                    var l = na.listeners("before"),
                        u = function() {
                            if (!l.length) return function() {
                                Zo(Xo, e, d), d.upload && Zo(Xo.concat(Jo), e.upload, d.upload), o = !0, e.open(t.method, t.url, t.async, t.user, t.pass);
                                for (var n = 0, a = ["type", "timeout", "withCredentials"]; n < a.length; n += 1) i = "type" === (r = a[n]) ? "responseType" : r, r in t && (e[i] = t[r]);
                            ...
                            var n = function(e) {
                                if ("object" == typeof e && ("number" == typeof e.status || "number" == typeof a.status)) return Ko(e, a), "data" in e || (e.data = e.response || e.text), void f(4);
                                u()
                            };
                            n.head = function(e) {
                                Ko(e, a), f(2)
            ...
            return d.UNSENT = 0, d.OPENED = 1, d.HEADERS_RECEIVED = 2, d.LOADING = 3, d.DONE = 4, d.response = "", d.responseText = "", d.responseXML = null, d.readyState = 0, d.statusText = "", d
        };
    aa.UNSENT = 0, aa.OPENED = 1, aa.HEADERS_RECEIVED = 2, aa.LOADING = 3, aa.DONE = 4;
    var ia = {
        patch: function() {
    ...
    var fa = function(e, t) {
            ...
            if (e instanceof Request) {
                var a = (n = e, r = {}, ["method", "headers", "body", "mode", "credentials", "cache", "redirect", "referrer", "referrerPolicy", "integrity", "keepalive", "signal", "url"].forEach((function(e) {
                        return r[e] = n[e]
                    })), r),
            ...
            return new Promise((function(t, n) {
                var r = this,
                    ...
                    i = function(e) {
                        ...
                        var t = c.shift();
                        return 2 === t.length ? (t(o, e), i(e)) : 3 === t.length ? t(o, e, i) : i(e)
                    },
                    l = function(e) {
                        if (void 0 !== e) {
                    ...
                    f = function() {
                        return sa(r, 0, void 0, (function*() {
                            ...
                            return e instanceof Request && r.body instanceof ReadableStream && (r.body = yield new Response(r.body).text()), ca(t, r).then((function(e) {
                                return i(e)
                            })).catch((function(e) {
                                return a = n, i(e), n(e)
                            }))
        ...
        if (r === o || yt()) t();
            ...
            var a = e.url,
                i = n.filter(_a).find((function(e) {
                    return t = a, !(!(n = e.url_wildcard) || "*" === n) && new RegExp("^" + n.replace(/\?/g, ".").replace(/\*/g, ".*") + "$").test(t);
                    var t, n
                }));
            ...
            function(e, t, n) {
                ...
                function c(e, t) {
                    "reverse_translate" === a && Gt(e, t), "reverse_handle_path" === a && t(Me().convertLocale(Ia.language_from, e))
                }
                switch (r) {
                    case "url_query":
                        try {
                            var l = new ge(i, "https://" + window.location.hostname),
                    ...
                    case "json_payload":
                        try {
                            ...
                            c(m, (function(n) {
                                var r;
                                e.body = JSON.stringify(Object.assign({}, JSON.parse(s), ((r = {})[o] = n, r))), t()
                            }))
                        } catch (e) {
                            t()
                        }
    ...
    function ha(e, t, n) {
        if (n || !e || window.top !== window || !ya(e)) {
            ...
            var o, a, i = yt();
            if (e && t && !i && kt(e), !Ia.is_connect || Ia.dynamicPushState || !i && e !== Ia.language_from ? function(e) {
                    void 0 === e && (e = !0);
                ...
                }(), o = Ia.xhr_hooks, a = Ia.is_connect, !(o && Array.isArray(o) && o.some(_a)) || a && yt() || (ga.enable(), ga.before(pa)), n || i) va(e);
            else if (Ia.is_connect && !i && je("onConnectPageLoad", e), Ia.force_translation) {
            ...
            i && !i.language_button_displayed && i.allExcluded || yo(), i || (Ia.remove_unused_link_hooks && function() {
                var e = wt(),
                ...
                for (var n = t.map((function(e) {
                        return ba(e)
                    })).join(","), r = _e(document, n), o = 0, a = r; o < a.length; o += 1) {
                    ye(a[o])
                }
            }(), xo(), bo(), function() {
                ...
                if (e)
                    for (var t = 0, n = _e(document.body, e); t < n.length; t += 1) {
                        var r = n[t];
                        r.contentWindow && Jt.push(r.contentWindow)
                    }
                Xt({}), Te("onPageLanguageSet", Yt), "with-window-top" === ke() && window.top.postMessage({
    ...
    function va(e, t) {
        if (!wt().includes(e)) return Mo(), void $.warn(e + " isn't a language you have added", {
            sendToDatadog: !1
        });
        Ia.auto_switch && Ho(e);
        var n = yt();
        if (Ia.is_connect || n || kt(e), !ya(e)) {
            if (Ia.loading_bar) var r = function() {
                try {
                    var e = document.createElement("div");
                    return e.className = "wg-progress", e.id = "wg_progress", e.innerHTML = '<div class="wg-progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0"></div>', document.body.appendChild(e), setInterval(qo, 100)
                } catch (e) {}
            }();
            if (function(e) {
                    var t = be("lang");
                    ...
                    Ue = e
                }(e), yt()) return Mo(), void zo(r);
            if (e === Ia.language_from) return je("onPageLanguageSet", e), Mo(), Mt(null, e), Ia.loading_bar && zo(r), document.documentElement.setAttribute("lang", e), void Ie("languageChanged", e, t || "");
            Vt(Ht(), e).then((function(n) {
                Mo(), Mt(n, e), document.documentElement.setAttribute("lang", e), Ie("languageChanged", e, t || ""), Ia.loading_bar && zo(r)
            })).catch((function(e) {
                throw Ia.loading_bar && zo(r), Mo(), Je().removeItem(J), e
            })), je("onPageLanguageSet", e)
        }
    }

    function ya(e) {
        return !(!Ia.is_connect || Be() === e) && (!Ia.host || Ia.previewHash && window.location.hostname.includes(G) || function() {
            if (Ia.subdirectory) return [Ia.host].concat(o);
            return Ia.languages.map((function(e) {
                return e.connect_host_destination && e.connect_host_destination.host
            })).concat([Ia.host].concat(o))
        }().includes(window.location.hostname) ? (rt(e, (function(e) {
            return window.location.replace(e)
        })), !0) : (ke() || $.warn('"' + window.location.hostname + '" is not configured with Weglot. Please contact support@weglot.com', {
            sendToDatadog: !1
        }), !1))
    }
    ga.EventEmitter = ea, ga.before = function(e, t) {
    ...
    }, ga.XMLHttpRequest = ia.Native, ga.fetch = da.Native, ga.headers = ta, ga.enable(), ga.disable(), Pe("initialized", (function() {
        Ia.translate_search && !Ia.switcher_editor && function() {
            var e = Ia.search_forms,
                t = Ia.search_parameter;
            if (t) {
                for (var n = 0, r = _e(document, e); n < r.length; n += 1) {
                    var o = r[n];
                    o.addEventListener("submit", (function(e) {
                        ...
                        Gt(n, (function(e) {
                            B.set({
                                ...
                                value: n,
                                options: Ia
                            }), o.elements[t].value = e, o.submit()
                        }))
                    }));
                    var a = void 0; - 1 !== window.location.search.indexOf(t + "=") && o.elements && o.elements[t] && (a = B.get("wg-search-form")) && (o.elements[t].value = a)
                }
                B.erase({
                    name: "wg-search-form",
                    options: Ia
                })
            } else $.warn("Search parameter name required for search translation.", {
                sendToDatadog: !1
            })
        }()
    }), !0);
    ...
    function ka(e, t) {
        ...
        }, wa.push(n)), t.setAttribute(Y, ""), t.classList.add("weglot-link", "weglot-link-" + e), e === Be() && (t.classList.add("weglot-link--active"), Ia.linkHooksConfig && Ia.linkHooksConfig.onLinkActive && Ia.linkHooksConfig.onLinkActive(t)), rt(e, (function(e) {
    ...
    function Ca(e, t) {
        if (void 0 === t && (t = ""), !e) return ue.button_style;
        var n = e.classF || "",
            r = n.match(/flag-(\d)/),
            o = {
    ...
    xa[Q] = function() {
        Te("onWeglotSetup", (function() {
            ...
            e && (Je({
                type: "cookie"
            }).removeItem("wg_checkout_redirect"), Je({
                type: "cookie"
            }).setItem("wg_checkout_language", e), st(e)), window.langify && $.log("%c Please, uninstall langify to properly use Weglot", {
                sendToDatadog: !1
            }), Ee() || !Ia.order_tag || Ia.is_connect && Ia.language_from !== Be() || dt(), ct();
            var t, n = document.querySelectorAll("[data-wg-only-display]");
            n.length && $e(n), Ia.customer_tag && ut(), document.getElementsByClassName("shopify-payment-button").length && (t = window.fetch, window.fetch = function() {
                if ("/wallets/checkouts.json" === arguments[0]) try {
                    var e = JSON.parse(arguments[1].body),
                        n = lt(Be());
                    e.checkout.attributes = {}, Ia.cart_attributes.forEach((function(t) {
                        return e.checkout.attributes[t] = n
                    })), arguments[1].body = JSON.stringify(e)
                } catch (e) {}
                return t.apply(window, arguments)
            })
        }), !0), Te("onConnectPageLoad", (function(e) {
            return gt(e)
            ...
            return ve("admin-bar-iframe") || ve("preview-bar-iframe") || Ia.private_mode || function() {
        ...
        var e = [".shopify-payment-button button"].concat(pt).concat(Ia.is_connect ? [] : ["form.cart.ajaxcart", "form.cart-drawer", "#cross-sell", ".wheelio_holder", ".mini-cart", "#shopify-product-reviews", "#esc-oos-form", ".product__add-to-cart-button", "select.product-variants>option:not([value])", ".ui-autocomplete", ".shopify-payment-button__button", "#shopify-section-static-recently-viewed-products", "#recently-viewed-products", "#shopify-section-product-recommendations", ".action_button.add_to_cart"]),
            ...
            n = "loox.io" === document.location.hostname && ke();
        ...
        return Te("onPageLanguageSet", (function(e) {
            ! function(e) {
                for (var t = 0, n = document.querySelectorAll('[href*="/checkout.php"],[href*="/cart.php"]'); t < n.length; t += 1) {
                    var r = n[t];
                    r.setAttribute("href", Oe(r.getAttribute("href"), "lang", e))
                }
            }(e)
        })), {
        ...
        document.getElementById("sqs-cart-root") && (e.push("#sqs-cart-container"), t.push("#sqs-cart-container [class*=subtotalPrice]", "#sqs-cart-container .cart-container .item-price")), document.getElementById("sqs-standard-checkout") && (e.push("#checkout"), t.push("#checkout span.money", "#checkout [data-test*=incomplete] [class^=PaymentCard-container]", "#checkout [data-test*=incomplete] [class^=CustomerAddress-container]", "#checkout [class^=CustomerInfoSection-email]", "#checkout [class^=GoogleResultsList]")), document.getElementById("order-status-page-root") && (e.push("#order-status-page-root"), t.push("#order-status-page-root #order-number", "#order-status-page-root h2 + div > p"));
        ...
        if (window.wixBiSession && "bolt" !== window.wixBiSession.renderType && !Ia.visual_editor && (document.addEventListener("DOMContentLoaded", (function() {
                new MutationObserver((function(e) {
                    for (var t = 0; t < e.length; t++) {
                        "SUCCESS" === e[t].target.getAttribute("data-santa-render-status") && (this.disconnect(), Ie("start"))
                    }
            ...
            var t = 0,
                n = setInterval((function() {
                    (document.body && window.sssr || 40 === t) && (Ie("start"), clearInterval(n)), t++
                }), 100);
                ...
                onLinkActive: function(e) {
                    ...
                    if (t) {
                        ...
                        if (n) {
                            ...
                            n.textContent = e.textContent, n.setAttribute("lang", e.getAttribute("lang")),
                                function(e, t) {
                                    var n = wa.find((function(t) {
                                        return t.language === e
                                    }));
                                ...
                                }(e.getAttribute("lang"), e), ka(o, e), e.textContent = r, e.setAttribute("lang", o)
                        }
                    } else e.classList.add("w--current"), e.setAttribute("aria-current", "lang")
                },
    ...
    function La(e) {
        ...
        return t.switchers && ("string" == typeof t.switchers && (t.switchers = JSON.parse(t.switchers)), t.switchers.length && t.switchers[0].styleOpt && (t.switchers = t.switchers.map(Oa)), t.scriptParamSwitcher = !0), Array.isArray(t.dynamic) && (t.dynamic = t.dynamic.join(",")), Array.isArray(t.translate_iframes) && (t.translate_iframes = t.translate_iframes.join(",")), t.translate_images && (t.media_enabled = !0), Sa.forEach((function(e) {
            var n = e.from,
                r = e.to,
                o = e.func;
    ...
    function ja(e) {
        ...
        var t = e.api_key.split("wg_").pop(),
            n = La(e);
        return function(e) {
            if (a(window.location.hostname)) return fetch("https://api.weglot.com/projects/settings?api_key=wg_" + e).then((function(e) {
                return e.json()
            }));
            var t = Aa();
            if (t) {
            ...
            if (o) return fetch("" + V + o + ".json").then((function(e) {
                return e.json()
            })).then((function(e) {
                return "SUBDOMAIN" === e.url_type && (e.languages = e.languages.map((function(e) {
                    return Object.assign({}, e, {
                        connect_host_destination: Object.assign({}, e.connect_host_destination, {
                            is_dns_set: !0,
                            created_on_aws: 1,
                            host: (e.custom_code || e.language_to) + "-" + o + "." + G
                        })
                    })
                }))), e.is_dns_set = !0, e.previewHash = o, e
            }));
            return fetch("" + V + e + ".json").then((function(e) {
                return e.json()
            }))
        }(t).then((function(e) {
            ...
            var o = r.language_from,
                a = r.languages;
            o && (n.language_from = o), a && (n.languages = a), t && t.localeRules && (n.localeRules = t.localeRules);
    ...
    function Pa(e) {
        ...
        e.injectedData || q(Ra), "SUBDIRECTORY" === e.url_type && e.is_dns_set && (e.subdirectory = !0), e.languages.length || (e.languages = []), Ta.is_connect = e.subdirectory || e.languages.some((function(e) {
            return e.connect_host_destination && e.connect_host_destination.is_dns_set && e.connect_host_destination.created_on_aws
        })), e.subdomain = !e.subdirectory && (e.subdomain || Ta.is_connect), e.dynamic && (e.dynamics || (e.dynamics = e.dynamic.split(",").map((function(e) {
            return {
                value: e.trim()
            }
        }))), delete e.dynamic), a(window.location.hostname) && (Ta.visual_editor = !0), Ta.private_mode = function() {
            -1 !== location.search.indexOf("weglot-private=0") && Je().removeItem("wg-private-mode");
            var e = document.getElementById("admin-bar-iframe") || document.getElementById("preview-bar-iframe") || -1 !== location.search.indexOf("weglot-private=1") || a(window.location.hostname) || "1" === Je({
                type: "cookie"
        ...
        var t, n, r, o = e.technology_name || Ta.technology_name,
            i = (t = o) && xa[t] ? xa[t]() : {},
            s = Object.assign({}, ue, i);
        if (Object.assign(Ta, s, e), ce.forEach((function(e) {
                var t, n;
                Ta[e] !== s[e] && (Ta[e] = (t = Ta[e], (n = s[e]) ? Array.isArray(t) ? [].concat(t, n) : "object" == typeof t ? Object.assign({}, t, n) : (t = t.split(",").filter((function(e) {
                    return e
                })).join(",")) && t.length > 0 && t !== n ? t += "," + n : t = n : t))
            })), n = "https://cdn.weglot.com/weglot.min.css?v=5", (r = document.createElement("link")).rel = "stylesheet", r.type = "text/css", r.href = n, document.head.appendChild(r), Ta.button_style && Ta.button_style.custom_css && xe(Ta.button_style.custom_css, "weglot-custom-style"), Ta.switchers && 0 !== Ta.switchers.length ? Ta.switchers = Ta.switchers.map((function(e) {
                ...
                location: {},
                default: !0
            }], Ta.cache && Ta.visual_editor && (Ta.cache = !1), Ta.api_key.length < 36 && (Ta.translation_engine = 1), Ta.excluded_blocks_remove && (Ta.excluded_blocks = Ta.excluded_blocks.filter((function(e) {
            ...
            }))), Ta.is_tld = !1, i.forceDisableConnect && (Ta.is_connect = !1), Ta.is_connect && !Ta.previewHash) {
            var c = Ta.host.split("www.").pop();
            Ta.is_tld = Ta.languages.some((function(e) {
                if (e.connect_host_destination && e.connect_host_destination.host) return -1 === e.connect_host_destination.host.indexOf(c)
            }))
        }
    ...
    function qa() {
        ...
        if (t.length) {
            ! function(e, t, n) {
                ...
                i.type = "text/javascript", i.src = e, i.addEventListener ? (i.addEventListener("load", o, !1), i.addEventListener("error", o, !1)) : i.readyState && (i.onreadystatechange = o), a.insertBefore(i, a.firstChild)
            ...
            if (je("onWeglotSetup"), !Xa.initialized || window.Turbolinks) {
                Fa = function() {
                    ...
                    if (Ia.is_connect) {
                        ...
                        if (Ia.technology_name === Q) {
                            if (B.get("wg_checkout_redirect")) return Ia.language_from;
                            var n = B.get("wg_checkout_language");
                            if (n && !Ia.shopifyCheckout && !ke() && e.includes(n)) return B.erase({
                ...
                var e = yt();
                if ((Ua = Fa && Fa !== Ia.language_from && document.documentElement.dataset.wgTranslated !== Fa && !e && !document.documentElement.dataset.wgExcludedUrl && !Ia.switcher_editor) && Ia.wait_transition ? xe("@keyframes wg{from{color:transparent;}to{color:transparent;}}body *{color:transparent!important;animation:1s linear infinite wg!important;}", X) : Mo(), Ia.delayStart) return Pe("start", (function() {
                    return Va()
                }), !0);
                q(Va)
            }
    ...
    var Xa = window.Weglot || {
        ...
        switchTo: ma,
        setup: function(e) {
            Ba(), Da || (Da = !0, Re(qa(), "polyfillReady", (function() {
                ja(e).then((function() {
                    return $a()
                })).catch((function() {
                    $.warn("Your setup is deprecated, please save settings in your dashboard to hide this message.", {
                        sendToDatadog: !1
                    });
                    var t = e.api_key;
        ...
        off: function(e, t) {
            ...
            for (var a = Ae.length - 1; a >= 0; a--) n(a) && (Ae.splice(a, 1), r = !0);
            return r
        },
        getStoredLang: bt,
        getLanguageName: qr,
        ...
        translate: function(e, t) {
            ...
            var n = e.words,
                r = e.languageTo;
            if (void 0 === r && (r = Be()), !Array.isArray(n) || "object" != typeof n[0]) {
                var o = "Weglot.translate: 1st arg must be an array of objects";
                return $.error(o, {
                    sendToDatadog: !1
                }), t && t(null, o), Promise.reject()
            }
    ...
    return Re(qa(), "polyfillReady", (function() {
        ...
        for (var e = 0, t = [document.currentScript].concat(Array.from(document.scripts)).filter(Boolean); e < t.length; e += 1) {
            ...
            if (r) {
                var o = Ja(r);
                if (o) return void Xa.initialize(o)
            }
        }
    })), Xa
}();