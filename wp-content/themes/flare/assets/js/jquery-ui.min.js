...
! function(t) {
    ...
    function c(r) {
        ...
        return r = r.toLowerCase(), h(t, function(t, e) {
            var n = e.re.exec(r),
                n = n && e.parse(n),
                e = e.space || "rgba";
            if (n) return n = o[e](n), o[l[e].cache] = n[l[e].cache], i = o._rgba = n._rgba, !1
    ...
    r.style.cssText = "background-color:rgba(1,1,1,.5)", s.rgba = -1 < r.style.backgroundColor.indexOf("rgba"), h(l, function(t, e) {
        ...
        parse: function(o, t, e, n) {
            ...
            var i = this,
                r = g(o),
                s = this._rgba = [];
            return void 0 !== t && (o = [o, t, e, n], r = "array"), "string" === r ? this.parse(c(o) || M._default) : "array" === r ? (h(l.rgba.props, function(t, e) {
                s[e.idx] = m(o[e.idx], e)
            }), this) : "object" === r ? (h(l, o instanceof u ? function(t, e) {
        ...
        transition: function(t, s) {
            var e = (f = u(t))._space(),
                n = l[e],
                t = 0 === this.alpha() ? u("transparent") : this,
    ...
    })).parse.prototype = u.fn, l.hsla.to = function(t) {
        ...
        h(t, function(t, i) {
            a.cssHooks[i] = {
                ...
                t.colorInit || (t.start = u(t.elem, i), t.end = u(t.end), t.colorInit = !0), a.cssHooks[i].set(t.elem, t.start.transition(t.end, t.pos))
            }
        })
    ...
    function T(t, e, n, r) {
        return t = {
            effect: t = d.isPlainObject(t) ? (e = t).effect : t
        }, "function" == typeof(e = null == e ? {} : e) && (r = e, n = null, e = {}), "number" != typeof e && !d.fx.speeds[e] || (r = n, n = e, e = {}), "function" == typeof n && (r = n, n = null), e && d.extend(t, e), n = n || e.duration, t.duration = d.fx.off ? 0 : "number" == typeof n ? n : n in d.fx.speeds ? d.fx.speeds[n] : d.fx.speeds._default, t.complete = r || e.complete, t
    }

    function W(t) {
        return !t || "number" == typeof t || d.fx.speeds[t] || ("string" == typeof t && !d.effects.effect[t] || ("function" == typeof t || "object" == typeof t && !t.effect))
    }
    ...
    d.effects = {
    ...
    }), d.effects.animateClass = function(o, t, e, n) {
        var i = d.speed(t, e, n);
        return this.queue(function() {
            ...
            r(), e = e.map(function() {
                return this.end = H(this.el[0]), this.diff = function(t, e) {
                    var n, r, o = {};
                    for (n in e) r = e[n], t[n] !== r && (x[n] || !d.fx.step[n] && isNaN(parseFloat(r)) || (o[n] = r));
                    return o
            ...
            }), d.when.apply(d, e.get()).done(function() {
                r(), d.each(arguments, function() {
                    var e = this.el;
        ...
        addClass: (y = d.fn.addClass, function(t, e, n, r) {
            return e ? d.effects.animateClass.call(this, {
                add: t
            }, e, n, r) : y.apply(this, arguments)
        }),
        removeClass: (b = d.fn.removeClass, function(t, e, n, r) {
            return 1 < arguments.length ? d.effects.animateClass.call(this, {
                remove: t
            }, e, n, r) : b.apply(this, arguments)
        }),
        toggleClass: (i = d.fn.toggleClass, function(t, e, n, r, o) {
            return "boolean" == typeof e || void 0 === e ? n ? d.effects.animateClass.call(this, e ? {
                add: t
            } : {
                remove: t
            }, n, r, o) : i.apply(this, arguments) : d.effects.animateClass.call(this, {
                toggle: t
            }, e, n, r)
        }),
    ...
    }), d.expr && d.expr.pseudos && d.expr.pseudos.animated && (d.expr.pseudos.animated = (C = d.expr.pseudos.animated, function(t) {
        return !!d(t).data(I) || C(t)
        ...
        createWrapper: function(n) {
            ...
            return n.wrap(t), n[0] !== o && !d.contains(n[0], o) || d(o).trigger("focus"), t = n.parent(), "static" === n.css("position") ? (t.css({
                position: "relative"
            }), n.css({
                position: "relative"
            })) : (d.extend(r, {
        ...
        removeWrapper: function(t) {
            ...
            return t.parent().is(".ui-effects-wrapper") && (t.parent().replaceWith(t), t[0] !== e && !d.contains(t[0], e) || d(e).trigger("focus")), t
        }
    }), d.extend(d.effects, {
        version: "1.13.2",
        define: function(t, e, n) {
            return n || (n = e, e = "effect"), d.effects.effect[t] = n, d.effects.effect[t].mode = e, n
        },
        ...
        createPlaceholder: function(t) {
            ...
            }).outerWidth(t.outerWidth()).outerHeight(t.outerHeight()), /^(static|relative)/.test(n) && (n = "absolute", e = d("<" + t[0].nodeName + ">").insertAfter(t).css({
        ...
        setTransition: function(r, t, o, i) {
            return i = i || {}, d.each(t, function(t, e) {
                var n = r.cssUnit(e);
                0 < n[0] && (i[e] = n[0] * o + n[1])
            }), i
        }
        ...
        effect: function() {
            function t(t) {
                var e = d(this),
                    n = d.effects.mode(e, a) || i;
                e.data(I, !0), c.push(n), i && ("show" === n || n === i && "hide" === n) && e.show(), i && "none" === n || d.effects.saveStyle(e), "function" == typeof t && t()
            }
            var r = T.apply(this, arguments),
                ...
                a = r.mode,
                c = [];
            return d.fx.off || !o ? a ? this[a](r.duration, s) : this.each(function() {
                s && s.call(this)
            ...
            function f(t) {
                ...
                r.mode = c.shift(), !1 === d.uiBackCompat || i ? "none" === r.mode ? (e[a](), n()) : o.call(e[0], r, function() {
                    e.removeData(I), d.effects.cleanUp(e), "hide" === r.mode && e.hide(), n()
                }) : (e.is(":hidden") ? "hide" === a : "show" === a) ? (e[a](), n()) : o.call(e[0], r, n)
            }
        },
        show: (_ = d.fn.show, function(t) {
            if (W(t)) return _.apply(this, arguments);
            t = T.apply(this, arguments);
            return t.mode = "show", this.effect.call(this, t)
        }),
        hide: (k = d.fn.hide, function(t) {
            if (W(t)) return k.apply(this, arguments);
            t = T.apply(this, arguments);
            return t.mode = "hide", this.effect.call(this, t)
        }),
        toggle: (w = d.fn.toggle, function(t) {
        ...
        transfer: function(t, e) {
            var n = d(this),
                ...
                r = n.offset(),
                c = d("<div class='ui-effects-transfer'></div>");
        ...
        t.clipInit || (t.start = d(t.elem).cssClip(), "string" == typeof t.end && (t.end = R(t.end, t.elem)), t.clipInit = !0), d(t.elem).cssClip({
            top: t.pos * (t.end.top - t.start.top) + t.start.top,
            right: t.pos * (t.end.right - t.start.right) + t.start.right,
            bottom: t.pos * (t.end.bottom - t.start.bottom) + t.start.bottom,
            left: t.pos * (t.end.left - t.start.left) + t.start.left
        })
    }, S = {}, d.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(e, t) {
        S[t] = function(t) {
        ...
        d.easing["easeIn" + t] = e, d.easing["easeOut" + t] = function(t) {
            return 1 - e(1 - t)
        }, d.easing["easeInOut" + t] = function(t) {
            return t < .5 ? e(2 * t) / 2 : 1 - e(-2 * t + 2) / 2
        }
    });
    d.effects, d.effects.define("slide", "show", function(t, e) {
        var n, r, o = d(this),
            i = {
                up: ["bottom", "top"],
                down: ["top", "bottom"],
            ...
            f = "up" === a || "left" === a,
            u = t.distance || o["top" == c ? "outerHeight" : "outerWidth"](!0),
            l = {};
        d.effects.createPlaceholder(o), n = o.cssClip(), r = o.position()[c], l[c] = (f ? -1 : 1) * u + r, l.clip = o.cssClip(), l.clip[i[a][1]] = l.clip[i[a][0]], "show" === s && (o.cssClip(l.clip), o.css(c, l[c]), l.clip = n, l[c] = r), o.animate(l, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: e
